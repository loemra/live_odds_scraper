...
def _setup_logger():
    ...
    logger = logging.getLogger("events_updater2")
    logger.propagate = False
    fh = logging.FileHandler("logs/events_updater2.log")
...
match_or_register_events("fox_bets", fox_bets.get_events)
match_or_register_events("bovada", bovada.get_events)
