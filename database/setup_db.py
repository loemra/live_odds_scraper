...
_maybe_add_markets(
    [
        ...
        # partial
        ("soccer_period_over_under_total_goals", "OVER_UNDER"),
        ("soccer_period_both_teams_to_score", "YES_NO"),
...
""" FOX_BETS
Market(name='SOCCER:FT:AXB', period='full', kind=<MarketKind.TEAM_NAME: 1>)
Market(name='SOCCER:FT:BTS', period='full', kind=<MarketKind.YES_NO: 3>)
Market(name='SOCCER:FT:OU', period='full', kind=<MarketKind.OVER_UNDER: 2>)
Market(name='SOCCER:P:BTS', period='H1', kind=<MarketKind.YES_NO: 3>)
Market(name='SOCCER:P:BTS', period='H2', kind=<MarketKind.YES_NO: 3>)
Market(name='SOCCER:P:OU', period='H1', kind=<MarketKind.OVER_UNDER: 2>)
Market(name='SOCCER:P:OU', period='H2', kind=<MarketKind.OVER_UNDER: 2>)
"""
...
_maybe_add_sb_markets(
    [
        ...
        ("SOCCER:P:OU", "soccer_period_over_under_total_goals", "fox_bets"),
        ("SOCCER:P:BTS", "soccer_period_both_teams_to_score", "fox_bets"),
